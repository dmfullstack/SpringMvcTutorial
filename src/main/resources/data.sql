...
insert into authorities (name) values ('technical user');
insert into authorities (name) values ('user');

insert into users_authorities (id_user, id_authority) values (1, 1);
insert into users_authorities (id_user, id_authority) values (1, 2);
insert into users_authorities (id_user, id_authority) values (1, 3);
insert into users_authorities (id_user, id_authority) values (2, 3);
insert into users_authorities (id_user, id_authority) values (3, 3);
